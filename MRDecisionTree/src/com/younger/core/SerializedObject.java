...
//      }
  ...
  public void writeObject(OutputStream outputStream){
	  ...
	  try {
		...
		objectOutputStream.write(this.m_storedObjectArray);
	} catch (Exception e) {
		e.printStackTrace();
	}finally{
		try {
...
//	  Id3 oId3= new Id3();
//	try {
//		SerializedObject serializedObject=new SerializedObject(oId3);
//		log.debug(serializedObject.getObject());
//		log.debug(serializedObject.getObject().getClass().getSimpleName());
//		serializedObject.writeObject(new FileOutputStream("id31.txt"));
//	} catch (Exception e) {
