...
public class AttributeSelectionPanel
  ...
  class AttributeTableModel
     ...
     */
    public AttributeTableModel(DataSet instances) {
    ...
    public void setInstances(DataSet instances) {
      ...
      m_Selected = new boolean [m_Instances.getDataList().get(0).getAttributeNum()];
    }
	...
	return new Boolean(m_Selected[row]);
      case 2:
	return m_Instances.getAttributeNamesList().get(row);
      default:
	return null;
      }
    }
    ...
    public void pattern(String pattern) {
      for (int i = 0; i < m_Selected.length; i++)
        m_Selected[i] = Pattern.matches(
                          pattern, m_Instances.getAttributeNamesList().get(i));
      fireTableRowsUpdated(0, m_Selected.length);
    }
   ...
   */
  public void setInstances(DataSet newInstances) {
...
//    	  DataSet i= null;
//      if (args.length == 0) {
//    	 String arg = "/Users/apple/Documents/workspace/weka/data/cpu.arff";
//    	i = new Instances(new java.io.BufferedReader(
//				  new java.io.FileReader(arg)));
//      }else{
//       i = new Instances(new java.io.BufferedReader(
