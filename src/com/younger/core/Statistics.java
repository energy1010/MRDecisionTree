...
public class Statistics {
  ...
  /**
   * Standard Normal Distribution Value</br>
  ...
  public static double normalDensityProbability(double a){
	  double y = Math.pow(a, 2)/2.0;
		double exp=Math.exp(-y);
		double b= 1.0/(Math.sqrt(2*Math.PI));
		return b*exp;
  }
  
  public static double normalDensityProbability(double value,double mean ,double sigma){
  ...
  public static void main(String[] ops) {
    ...
    System.out.println("Normal probability (-0.2): " +
		       Statistics.normalProbability(-0.2));
    System.out.println("Normal probability (0.5): " +
		       Statistics.normalProbability(0.5));
    System.out.println("Normal probability (0.8): " +
		       Statistics.normalProbability(0.8));
    System.out.println("Normal probability (0): " +
		       Statistics.normalProbability(0));
    System.out.println("Normal probability (0.01): " +
		       Statistics.normalProbability(0.01));
    ...
    System.out.println("Normal probability (0.2): " +
		      MathUtil.normalProbability(0.2));
    System.out.println("Normal probability (-0.2): " +
		      MathUtil.normalProbability(-0.2));
  }
}
